...
const Donate = () => {
  ...
  const [showDonationForm, setDonationForm] = useState(true);
  const [pdfContent, setPdfContent] = useState(null);
  const [cardNumber, setCardNumber] = useState('');
  const [cardName, setCardName] = useState('');
  const [cardExpiry, setCardExpiry] = useState('');
  const [cardCVC, setCardCVC] = useState('');
  const [donationRecipientEmail, setDonationRecipientEmail] = useState('');
  ...
  const handleFormSubmit = (e) => {
    ...
    axios
      ...
      // Set donation recipient email and name to state
      setDonationRecipientEmail(email);
      setDonationRecipientName(fullname);
  ...
  const handleCheckout = () => {
    ...
    // const params = {
    // to_email: donationRecipientEmail,  // Set the donation provider's email address as the recipient
    // to_name: donationRecipientName, // Set the donation provider's name
  ...
  return (
    ...
    <div className="card-form-container">
          ...
          <input
            ...
            required
            style={{ width: '215px', marginRight: '30px' }}
