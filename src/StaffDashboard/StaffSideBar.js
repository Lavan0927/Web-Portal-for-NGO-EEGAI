          ...
          <MDBListGroup flush className="mx-3 mt-4">
            ...
            <MDBCollapse show={collapse1}>
              ...
              <MDBListGroupItem className="py-1" tag={Link} action to='/'>Visit Home</MDBListGroupItem>
                <MDBListGroupItem className="py-1" tag={Link} action to='/StaffDashboard'>Dashboard</MDBListGroupItem>
                <MDBListGroupItem className="py-1" tag={Link} action to='/ManageUsers'>Manage Profile</MDBListGroupItem>  
                <MDBListGroupItem className="py-1" tag={Link} action to='/ManageProject'>Manage Project</MDBListGroupItem> 
                <MDBListGroupItem className="py-1" tag={Link} action to='/StaffManageActivity'>Manage Activity</MDBListGroupItem> 
                <MDBListGroupItem className="py-1" tag={Link} action to='/StaffManageEvent'>Manage Event</MDBListGroupItem> 
