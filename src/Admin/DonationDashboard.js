...
import DonationsByProject from "./DonationByProject";
import DonationsByActivity from "./DonationsByActivity";
...
function DonationDashboard() {
  ...
  const generateDonationPDF = async () => {
    const section = document.getElementById("donation-section01");
  ...
  const generateVolunteerPDF = async () => {
    const section = document.getElementById("donation-section02");
    await generateSectionPDF(section, "Donation Report");
  };

   // Function to generate PDF for the Volunteer section
   const generateStaffPDF = async () => {
    const section = document.getElementById("donation-section03");
    await generateSectionPDF(section, "Donation Report");
  };
...
const generateReportPDF = async () => {
  ...
  const sections = [
    { section: "donation-section01", title: "Donation Report" },
    { section: "donation-section02", title: "Donation Report" },
    { section: "donation-section03", title: "Donation Report" },
...
{/* 
        ...
        <h2 style={{display: 'flex',color: '#1c1c1e',marginBottom: '10px'}}>Donations For Project Overview</h2>
        <br></br>
        <DonationsByProject />
        </section>
        ...
        <section id="donation-section03" >
        <br></br><br></br>
          <h2 style={{display: 'flex',color: '#1c1c1e',marginBottom: '10px'}}>Donations For Activity Overview</h2>
          <br></br>
          <DonationsByActivity />
        </section>
        
        {/* <button onClick={generateReportPDF}>Generate Donation PDF</button> */}
        <center><Button variant="outlined" onClick={generateReportPDF}>Generate Donation Report PDF</Button></center>
